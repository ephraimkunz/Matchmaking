/* @ts-self-types="./matchmaking.d.ts" */

/**
 * @param {string} csv_text
 * @param {boolean} sort_shortlists_by_score
 * @param {boolean} print_scores
 * @param {boolean} collect_diagnostics
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('matchmaking_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
